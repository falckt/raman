...
def parse_wdf1(data, parsed_data):
    fields = [
        ('padding1', '44s'),
...
def parse_data(data, parsed_data):
...
def parse_wmap(data, parsed_data):
    fields = [
        ('padding', '8s'),
        ('x0', 'f'),
        ('y0', 'f'),
...
def parse_origin(data, parsed_data):
    N = parsed_data['WDF1']['measured_spectra']
...
def parse_text(data, parsed_data):
